  ...
  return (
    <>
      ...
      {restaurantsLoading ? (
        ...
        <>
          <section>
            <h2 className="restaurants-heading">Restaurants to explore</h2>

            <div className="sort">
              <button className="filter-chip" onClick={handleToggleVegOnly}>
                🌱 {showVegOnly ? "Show All" : "Pure Veg"}
              </button>

              <button className="filter-chip" onClick={handleSortByReviews}>
                Sort By Reviews
              </button>

              <button className="filter-chip" onClick={handleSortByRatings}>
                ★ Sort By Ratings
              </button>
            </div>
